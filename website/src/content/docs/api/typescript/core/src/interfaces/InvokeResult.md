...
[nekte-protocol](../../../index.md) / [core/src](../index.md) / InvokeResult
...
> **out**: `Record`\<`string`, `unknown`\> \| [`MultiLevelResult`](MultiLevelResult.md)\<`string`, `Record`\<`string`, `unknown`\>, `Record`\<`string`, `unknown`\>\>
...
> `optional` **resolved\_level?**: [`DetailLevel`](../type-aliases/DetailLevel.md)
